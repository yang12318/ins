...
public class FunGameHeader extends FrameLayout {
    ...
    private com.example.yang.ins.FunGameView funGameView;
    ...
    private String topMaskViewText = "其实这是一个彩蛋";
    private String bottomMaskViewText = "松手开始游戏";
    private String loadingText = "Loading...";
    private String loadingFinishedText = "刷新已完成";
